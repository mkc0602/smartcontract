...
contract MLaunchSale is Ownable {
    using SafeMath for uint256;

    // 4 rounds : 0 = not open, 1 = guaranteed spot, 2 = FCFS, 3 = Sale over
    ...
    uint256 public round1Duration = 86400; // in secondes 86400 = 24h

    IERC20 public stableCoin =
        IERC20(xxxxxxxxxxxxxxxxxxxxxxxxx); /sale contribution currency
    ...
    uint256 public stableTarget = xxxx  * 1E18;
    uint256 public tokenTarget = xxxx  * 1E18;
    uint256 public multiplier = xxx ; // div per 100
    ...
    function buyRound2Stable(uint256 _amount) external {
        require(_roundNumber() == 2, "FCFS ROUND");
